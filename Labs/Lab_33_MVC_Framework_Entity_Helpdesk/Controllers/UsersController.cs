...
using Lab_33_MVC_Framework_Entity_Helpdesk;

namespace Lab_33_MVC_Framework_Entity_Helpdesk.Controllers
{
    public class UsersController : Controller
    {
        private HelpdeskModel db = new HelpdeskModel();

        // GET: Users
        public ActionResult Index()
        {
            var users = db.Users.Include(u => u.Category);
